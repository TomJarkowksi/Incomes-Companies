...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/core-js/library/modules/_string-ws.js":[function(require,module,exports) {
...
},{"core-js/library/fn/parse-float":"node_modules/core-js/library/fn/parse-float.js"}],"node_modules/core-js/library/modules/_an-instance.js":[function(require,module,exports) {
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/summing.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.summing = summing;
...
function summing(array) {
  ...
  array.forEach(function (el) {
    sum += (0, _parseFloat2.default)(el.value);
  });
  return sum;
}
},{"@babel/runtime-corejs2/core-js/parse-float":"node_modules/@babel/runtime-corejs2/core-js/parse-float.js"}],"node_modules/core-js/library/modules/_parse-int.js":[function(require,module,exports) {
...
},{"core-js/library/fn/parse-int":"node_modules/core-js/library/fn/parse-int.js"}],"node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js":[function(require,module,exports) {
...
},{"../core-js/object/define-property":"node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"node_modules/moment/moment.js":[function(require,module,exports) {
var define;
...
},{"moment":"node_modules/moment/moment.js"}],"src/js/MonthlyIncomes.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MonthlyIncomes = void 0;
...
var _Chart = require("../../node_modules/chart.js/dist/Chart.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MonthlyIncomes = /*#__PURE__*/function () {
  function MonthlyIncomes() {
    (0, _classCallCheck2.default)(this, MonthlyIncomes);
  }

  (0, _createClass2.default)(MonthlyIncomes, [{
    key: "displayChart",
    value: function displayChart(dataIncomes) {
      var _this = this;

      this.sortedIncomes = dataIncomes.sort(function (a, b) {
        return a[1] - b[1] || a[2] - b[2] || a[3] - b[3];
      });
      this.monthIncomesArr = [];
      this.monthIncomes = 0;
      this.sortedIncomes.forEach(function (el, index) {
        if (index < _this.sortedIncomes.length - 1 && el[2] == _this.sortedIncomes[index + 1][2]) {
          _this.monthIncomes += (0, _parseFloat2.default)(el[0]);
        } else {
          _this.monthIncomes += (0, _parseFloat2.default)(el[0]);
          _this.oneMonth = [_this.monthIncomes, el[1], el[2]];

          _this.monthIncomesArr.push(_this.oneMonth);

          _this.monthIncomes = 0;
        }
      });
      this.configurationChart(this.monthIncomesArr);
    }
  }, {
    key: "configurationChart",
    value: function configurationChart(data) {
      var _this2 = this;
      ...
      data.forEach(function (el) {
        el[2] < 10 ? _this2.x.push("".concat(el[1], "-0").concat(el[2])) : _this2.x.push("".concat(el[1], "-").concat(el[2]));

        _this2.y.push(el[0].toFixed(2));
      });
      this.myChart = new _Chart.Chart(this.ctx, {
        type: 'bar',
        labels: [],
        data: {
          datasets: [{
...
exports.MonthlyIncomes = MonthlyIncomes;
},{"@babel/runtime-corejs2/core-js/parse-float":"node_modules/@babel/runtime-corejs2/core-js/parse-float.js","@babel/runtime-corejs2/helpers/classCallCheck":"node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"node_modules/@babel/runtime-corejs2/helpers/createClass.js","../../node_modules/chart.js/dist/Chart.js":"node_modules/chart.js/dist/Chart.js"}],"src/js/DisplayDetails.js":[function(require,module,exports) {
"use strict";
...
var _MonthlyIncomes = require("./MonthlyIncomes.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var DisplayDetails = /*#__PURE__*/function () {
  function DisplayDetails() {
    (0, _classCallCheck2.default)(this, DisplayDetails);
    ...
    this.chart = new _MonthlyIncomes.MonthlyIncomes();
  }

  (0, _createClass2.default)(DisplayDetails, [{
    key: "displayData",
    value: function displayData(data) {
      ...
      console.log(data);
      console.log(this.lastYearIncomes);
      console.log(this.lastMonthIncomes);
      var sum = 0;
      this.lastMonthIncomes.forEach(function (el) {
        sum += (0, _parseFloat2.default)(el[0]);
      });
      this.average.innerText = ((0, _parseFloat2.default)(data[0][3]) / this.dataIncomes.length).toFixed(2);
      this.lastMonth.innerText = sum.toFixed(2);
    ...
    key: "dataConversion",
    value: function dataConversion(dataToConversion) {
      var arrayAfterConversion = [];
      dataToConversion.incomes.forEach(function (el) {
        var year = (0, _parseInt2.default)(el.date.slice(0, 4));
        var month = (0, _parseInt2.default)(el.date.slice(5, 7));
        var hour = (0, _parseInt2.default)(el.date.slice(8, 10));
        var oneArr = [(0, _parseFloat2.default)(el.value), year, month, hour];
    ...
    key: "sliceIncomes",
    value: function sliceIncomes(data, column) {
      var _this = this;

      this.dataSorted = data.sort(function (a, b) {
        return a[column] - b[column];
      }).reverse();
      var endSlice;
      var flague = true;
      this.dataSorted.forEach(function (el, index) {
        if (el[column] !== _this.dataSorted[0][column] && flague) {
          endSlice = index;
          flague = !flague;
        }
      });
    ...
    key: "dateRange",
    value: function dateRange(dataIncomes) {
      var _this2 = this;

      this.inputFrom.addEventListener("change", function (_ref) {
        var target = _ref.target;
        _this2.rangeFrom = [];

        _this2.rangeFrom.push((0, _parseInt2.default)(target.value.slice(0, 4)), (0, _parseInt2.default)(target.value.slice(5, 7)), (0, _parseInt2.default)(target.value.slice(8, 10)));
      });
      this.inputTo.addEventListener("change", function (_ref2) {
        var target = _ref2.target;
        _this2.rangeTo = [];

        _this2.rangeTo.push((0, _parseInt2.default)(target.value.slice(0, 4)), (0, _parseInt2.default)(target.value.slice(5, 7)), (0, _parseInt2.default)(target.value.slice(8, 10)));

        console.log(_this2.rangeFrom);
        console.log(_this2.rangeTo);
        _this2.onlyDataWithRange = _this2.serchDataWithRange(_this2.rangeFrom, _this2.rangeTo, dataIncomes);

        _this2.dsd(_this2.onlyDataWithRange);
      });
    }
  }, {
    key: "serchDataWithRange",
    value: function serchDataWithRange(rangeFrom, rangeTo, dataIncomes) {
      var _this3 = this;

      this.sortAscending = dataIncomes.sort(function (a, b) {
        return a[1] - b[1] || a[2] - b[2] || a[3] - b[3];
      });
      var indexStart;
      var indexEnd;
      ...
      this.sortAscending.forEach(function (el, index) {
        if (el[1] == rangeFrom[0] && el[2] == rangeFrom[1] && el[3] >= rangeFrom[2] && _this3.flague1) {
          indexStart = index;
          _this3.flague1 = false;
        } else if (el[1] > rangeFrom[0] && _this3.flague1) {
          indexStart = index;
          _this3.flague1 = false;
        } else if (el[1] == rangeFrom[0] && el[2] > rangeFrom[1] && _this3.flague1) {
          indexStart = index;
          _this3.flague1 = false;
        }
      });
      this.sortDecreasing.forEach(function (el, index) {
        if (el[1] == rangeTo[0] && el[2] == rangeTo[1] && el[3] <= rangeTo[2] && _this3.flague2) {
          indexEnd = index;
          _this3.flague2 = false;
        } else if (el[1] < rangeTo[0] && _this3.flague2) {
          indexEnd = index;
          _this3.flague2 = false;
        } else if (el[1] == rangeTo[0] && el[2] < rangeTo[1] && _this3.flague2) {
          indexEnd = index;
          _this3.flague2 = false;
        }
      });
      ...
      console.log(this.sortDecreasing.length - indexEnd - 1);
      return this.sortAscending.slice(indexStart, this.sortDecreasing.length - indexEnd);
    }
  }, {
    key: "dsd",
    value: function dsd(onlyDataWithRange) {
      this.totalIncome = document.createElement("p");
      this.averageIncome = document.createElement("p");
      var as = 0;
      onlyDataWithRange.forEach(function (el) {
        as += (0, _parseFloat2.default)(el[0]);
      });
      this.totalIncome.innerHTML = "Total Income : ".concat(as.toFixed(2));
      this.averageIncome.innerHTML = "Average Income".concat((as / onlyDataWithRange.length).toFixed(2));
    ...
    value: function closeDetails() {
      ...
      this.buttonBack.addEventListener("click", function () {
        _this4.detailsView.style.display = "none";
        _this4.tableView.style.display = "block";
      });
    }
  }, {
    key: "openDetails",
...
},{"@babel/runtime-corejs2/core-js/parse-int":"node_modules/@babel/runtime-corejs2/core-js/parse-int.js","@babel/runtime-corejs2/core-js/parse-float":"node_modules/@babel/runtime-corejs2/core-js/parse-float.js","@babel/runtime-corejs2/helpers/classCallCheck":"node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"node_modules/@babel/runtime-corejs2/helpers/createClass.js","./MonthlyIncomes.js":"src/js/MonthlyIncomes.js"}],"src/js/companyDetails.js":[function(require,module,exports) {
"use strict";
...
var _DisplayDetails = require("./DisplayDetails.js");

function companyDetails(table) {
  var rowki = document.querySelectorAll("tbody .id");
  var details = new _DisplayDetails.DisplayDetails();
  rowki.forEach(function (el) {
    var sdsds = [];
    el.addEventListener("click", function (e) {
      table.forEach(function (az) {
        if (az[0] == e.target.innerText) {
          sdsds.push(az);
        }
      });
      details.displayData(sdsds);
    });
  });
}
},{"./DisplayDetails.js":"src/js/DisplayDetails.js"}],"src/js/displayTable.js":[function(require,module,exports) {
"use strict";
...
var _companyDetails = require("./companyDetails.js");

var placeForTable = document.querySelector("tbody");
var currentPage = 1;
var rowsInOnePage = 35;
...
function displayTable(tabelToDisplay, resetCurrentPage) {
  ...
  currentPage--;
  var start = rowsInOnePage * currentPage;
  var end = start + rowsInOnePage;
  var paginatedItems = tabelToDisplay.slice(start, end);
  paginatedItems.forEach(function (el) {
    var tr = document.createElement("tr");
    tr.innerHTML = "\n        <td class = \"id\">".concat(el[0], "</td>\n        <td class = \"name\">").concat(el[1], "</td>\n        <td>").concat(el[2], "</td>\n        <td>").concat(el[3], "</td>");
    placeForTable.appendChild(tr);
  });
  setupPagination(tabelToDisplay, rowsInOnePage);
  (0, _companyDetails.companyDetails)(tabelToDisplay);
}

var placeForPagination = document.querySelector(".pagination");

function setupPagination(tabelToDisplay, rowsInOnePage) {
  placeForPagination.innerHTML = "";
  var page_count = Math.ceil(tabelToDisplay.length / rowsInOnePage);

  for (var i = 1; i < page_count + 1; i++) {
    var btn = paginationButton(i, tabelToDisplay);
    placeForPagination.appendChild(btn);
  }
}

function paginationButton(az, tomek) {
  ...
  div.addEventListener("click", function () {
    currentPage = az;
    (0, _sorting.sorting)(tomek, 3, false);
  });
  return div;
}
},{"./sorting.js":"src/js/sorting.js","./companyDetails.js":"src/js/companyDetails.js"}],"src/js/sorting.js":[function(require,module,exports) {
"use strict";
...
var _displayTable = require("./displayTable.js");

function sorting(tableToSort, whichColumn, resetCurrentPage) {
  var tableSorted = tableToSort.sort(function (a, b) {
    return a[whichColumn] - b[whichColumn];
  }).reverse();
  (0, _displayTable.displayTable)(tableSorted, resetCurrentPage);
}
},{"./displayTable.js":"src/js/displayTable.js"}],"src/js/serch.js":[function(require,module,exports) {
"use strict";
...
function serch(table) {
  ...
  input.addEventListener("keyup", function (e) {
    var arrayWithFoundCompanies = [];
    table.forEach(function (el) {
      if (el[1].toLowerCase().includes(e.target.value.toLowerCase())) {
        arrayWithFoundCompanies.push(el);
      }
    });

    if (e.target.value == null) {
      (0, _sorting.sorting)(table, 3, false);
    } else {
      (0, _sorting.sorting)(arrayWithFoundCompanies, 3, true);
    }
  });
}
},{"./sorting.js":"src/js/sorting.js"}],"src/js/init.js":[function(require,module,exports) {
"use strict";
...
var _summing = require("./summing.js");

var _sorting = require("./sorting.js");

var _serch = require("./serch.js");
...
var getData = function getData() {
  var urlData = "https://recruitment.hal.skygate.io/companies";
  fetch(urlData).then(function (response) {
...
function getIncome(_x) {
  return _getIncome.apply(this, arguments);
}

function _getIncome() {
  _getIncome = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(arrayWithCompanies) {
    ...
    return _regenerator.default.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _iterator = _createForOfIteratorHelper(arrayWithCompanies);
            _context2.prev = 1;
            _loop = /*#__PURE__*/_regenerator.default.mark(function _loop() {
              var company, urlIncome;
              return _regenerator.default.wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      company = _step.value;
                      urlIncome = "https://recruitment.hal.skygate.io/incomes/".concat(company.id);
                      _context.next = 4;
                      return fetch(urlIncome).then(function (response) {
                        if (response.status !== 200) {
                          throw new Error("Ups");
                        } else {
                          return response.json();
                        ...
                        saveData(response, company.id, company.name, company.city);
                      }).catch(function (err) {
                        return console.log(err);
                      });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/init.js"], null)
//# sourceMappingURL=/init.e74bdbc0.js.map