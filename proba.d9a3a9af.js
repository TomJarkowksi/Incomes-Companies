...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/proba.js":[function(require,module,exports) {
"use strict";
...
function wszystko(response, id, name, city) {
  ...
  user.push(id, name, city, sum.toFixed(2));
  info.push(user);
}
...
function display() {
  table.innerHTML = "";
  currentPage--;
  var start = rows * currentPage;
  var end = start + rows;
  var paginatedItems = info.slice(start, end);
  paginatedItems.forEach(function (el) {
    var tr = document.createElement("tr");
    tr.innerHTML = "\n        <td>".concat(el[0], "</td>\n        <td class=\"name\">").concat(el[1], "</td>\n        <td>").concat(el[2], "</td>\n        <td>").concat(el[3], "</td>");
    table.appendChild(tr);
  });
  setupPagination(info);
  mozliwoscWyszukania();
}
...
function setupPagination() {
  ...
  var page_count = Math.ceil(info.length / rows);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/proba.js"], null)
//# sourceMappingURL=/proba.d9a3a9af.js.map