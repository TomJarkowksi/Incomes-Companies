...
},{"core-js/library/fn/parse-float":"node_modules/core-js/library/fn/parse-float.js"}],"node_modules/core-js/library/modules/es6.object.to-string.js":[function(require,module,exports) {
  ...
  (0, _createClass2.default)(DisplayDetails, [{
    ...
    value: function dateRange(dataIncomes) {
      ...
      this.buttonDate.addEventListener("click", function () {
        ...
        if (_this2.checkDateInput(_this2.rangeFrom, _this2.rangeTo)) {
          return _this2.displayError();
        }
    ...
    key: "checkDateInput",
    value: function checkDateInput(rangeFrom, rangeTo) {
...
function companyDetails(table) {
  ...
  rows.forEach(function (row) {
    row.addEventListener("click", function (e) {
      var id = getId(row.innerText);
      var dataCompany = table.filter(function (el) {
        return el[0] == id;
      });
...
function serch(table) {
  ...
  input.addEventListener("keyup", function (e) {
    var arrayWithFoundCompanies = table.filter(function (el) {
...
function getIncome(arrayWithCompanies) {
  var requests = arrayWithCompanies.map(function (company) {
    return fetch("https://recruitment.hal.skygate.io/incomes/".concat(company.id));
  });

  _promise.default.all(requests).then(function (responses) {
    return responses;
  }).then(function (responses) {
    return _promise.default.all(responses.map(function (r) {
      return r.json();
    }));
  }).then(function (response) {
    return saveData(response, arrayWithCompanies);
  });
}

function saveData(response, companiesArr) {
  companiesArr.forEach(function (el, index) {
    var rowInTable = [];
    var sumIncomes = (0, _summing.summing)(response[index].incomes);
    rowInTable.push(el.id, el.name, el.city, (0, _parseFloat2.default)(sumIncomes.toFixed(2)), response[index]);
...
getData();
},{"@babel/runtime-corejs2/core-js/parse-float":"node_modules/@babel/runtime-corejs2/core-js/parse-float.js","@babel/runtime-corejs2/core-js/promise":"node_modules/@babel/runtime-corejs2/core-js/promise.js","../style/style.css":"src/style/style.css","./summing.js":"src/js/summing.js","./sorting.js":"src/js/sorting.js","./serch.js":"src/js/serch.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
