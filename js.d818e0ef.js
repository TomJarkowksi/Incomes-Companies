  ...
  (0, _createClass2.default)(DisplayDetails, [{
    ...
    value: function dateRange(dataIncomes) {
      ...
      this.buttonDate.addEventListener("click", function () {
        ...
        _this2.rangeFrom.push((0, _parseInt2.default)(_this2.inputFrom.value.slice(0, 4)), (0, _parseInt2.default)(_this2.inputFrom.value.slice(5, 7)), (0, _parseInt2.default)(_this2.inputFrom.value.slice(8, 10)));

        _this2.rangeTo.push((0, _parseInt2.default)(_this2.inputTo.value.slice(0, 4)), (0, _parseInt2.default)(_this2.inputTo.value.slice(5, 7)), (0, _parseInt2.default)(_this2.inputTo.value.slice(8, 10)));

        _this2.onlyDataWithRange = _this2.serchDataWithRange(_this2.rangeFrom, _this2.rangeTo, dataIncomes);

        _this2.displayDetailsWithRange(_this2.onlyDataWithRange);
      });
    }
  }, {
    ...
    key: "displayDetailsWithRange",
    value: function displayDetailsWithRange(onlyDataWithRange) {
      ...
      this.totalIncome.innerHTML = "Total Income : ".concat(this.averageIncomeValue.toFixed(2));
      this.averageIncome.innerHTML = "Average Income: ".concat(this.averageIncomeValue ? (this.averageIncomeValue / onlyDataWithRange.length).toFixed(2) : 0.00);
      this.results.innerHTML = "";
    ...
    value: function closeDetails() {
      ...
      this.buttonBack.addEventListener("click", function () {
        ...
        _this4.tableView.style.display = "flex";
      });
    }
  }, {
    key: "openDetails",
...
},{"./sorting.js":"src/js/sorting.js"}],"src/js/index.js":[function(require,module,exports) {
"use strict";
