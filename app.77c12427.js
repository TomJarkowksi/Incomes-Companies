...
},{"core-js/library/fn/parse-int":"node_modules/core-js/library/fn/parse-int.js"}],"node_modules/core-js/library/modules/_parse-float.js":[function(require,module,exports) {
...
var getTabel = function getTabel() {
  var url = "https://recruitment.hal.skygate.io/companies";
...
function wywolaj(_x) {
  return _wywolaj.apply(this, arguments);
}

function _wywolaj() {
  _wywolaj = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(tablica) {
    ...
    return _regenerator.default.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _iterator = _createForOfIteratorHelper(tablica);
            _context2.prev = 1;
              ...
              return _regenerator.default.wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      el = _step.value;
                      urls = "https://recruitment.hal.skygate.io/incomes/".concat(el.id);
                      _context.next = 4;
                      return fetch(urls).then(function (response) {
                        if (response.status !== 200) {
                          throw new Error("Ups");
                        } else {
                          return response.json();
                        ...
                        wszystko(response, el.id, el.name, el.city);
                      }).catch(function (err) {
                        return console.log(err);
                      });
...
function wszystko(response, id, name, city) {
  var sum = 0;
  response.incomes.forEach(function (el) {
    sum += (0, _parseFloat2.default)(el.value);
  });
  var tr = document.createElement("tr");
  tr.innerHTML = "\n    <td>".concat(id, "</td>\n    <td class=\"name\">").concat(name, "</td>\n    <td>").concat(city, "</td>\n    <td>").concat(sum.toFixed(2), "</td>");
...
function sortowanie() {
  ...
  allRows.forEach(function (el) {
    var row = el.querySelectorAll("td");
    console.log(row);
    console.log(el.innerHTML);
    var oneRowArray = [];
    oneRowArray.push((0, _parseInt2.default)(row[3].innerHTML), el.innerHTML);
    rowsArray.push(oneRowArray);
  });
  render();
}
...
input.addEventListener("keyup", function (e) {
  var sa = document.querySelectorAll(".name");
  pagination();
